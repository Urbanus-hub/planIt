        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="font-size: 16px;">We're thrilled to have you join our community${role === "vendor"
              ...
              <div style="text-align: center;">
                <a href="${process.env.FRONTEND_URL || "http://localhost:3000"}/login" class="btn">Get Started</a>
              </div>
