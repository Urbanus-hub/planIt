...
router.post("/create", async (req, res) => {
    try {
        ...
        if (!conversation) {
            ...
            console.log(`✅ New conversation created between ${currentUserId} and ${participantId}: ${conversation._id}`);
        }
        else {
            console.log(`🔍 Existing conversation found between ${currentUserId} and ${participantId}: ${conversation._id}`);
        }
...
//# sourceMappingURL=conversations.route.js.map