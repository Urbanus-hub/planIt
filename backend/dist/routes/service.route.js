...
router.patch("/:id", authorize, authorizeRole("vendor", "admin"), verifyServiceOwnership, updateService);
// Delete service (service owner or admin)
router.delete("/:id", authorize, authorizeRole("vendor", "admin"), verifyServiceOwnership, deleteService);
