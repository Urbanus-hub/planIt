...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group toast backdrop-blur-xl border border-gray-200 dark:border-gray-700 shadow-2xl rounded-xl p-4 min-w-[320px] max-w-[420px] bg-white/95 dark:bg-gray-800/95 transition-all duration-300",
          title: "font-semibold text-base text-gray-900 dark:text-gray-100",
          description: "text-sm text-gray-600 dark:text-gray-300 mt-1 leading-relaxed",
          actionButton: "bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-colors",
          cancelButton: "bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors",
          closeButton: "!bg-gray-100 hover:!bg-gray-200 dark:!bg-gray-700 dark:hover:!bg-gray-600 !text-gray-600 dark:!text-gray-400 !border-gray-300 dark:!border-gray-600 hover:!border-gray-400 dark:hover:!border-gray-500 transition-all",
