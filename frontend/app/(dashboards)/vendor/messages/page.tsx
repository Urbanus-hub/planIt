...
export default function VendorMessages() {
  ...
  const messagingResult = useMessaging({
    ...
    onMessageReceived: (message) => {
      console.log("📨 New message received in vendor:", message);
  ...
  const loadConversations = async () => {
    try {
      ...
      const conversationsWithOnlineStatus = initialConversations.map(
        (conv) => ({
          ...conv,
          online: isUserOnline(conv.clientId),
        })
      );
  ...
  const handleSendMessage = () => {
    ...
    sendMessage(messageInput, currentConversation.clientId);
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Avatar className="h-10 w-10">
                      <AvatarImage
                        ...
                        alt={currentConversation.client}
                      />
                      <AvatarFallback className="bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-200">
                        {currentConversation.client.charAt(0)}
                      </AvatarFallback>
                    </Avatar>
                    <div>
                      ...
                      <div className="text-center max-w-md mx-auto p-6">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
                          {currentConversation?.isNew
                            ? `Start a conversation with ${currentConversation.client}. Send them a message to discuss their event needs!`
                      ...
                      <Input
                        placeholder={
                          !isConnected
                            ...
                            ? "Loading messages..."
                            : currentConversation?.isNew
                            ? `Message ${currentConversation.client}...`
                            : "Type a message..."
                        }
                        value={messageInput}
