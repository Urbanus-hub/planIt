...
export default function VendorDashboard() {
  ...
  const topServices = [
    { name: "Wedding Photography Package", bookings: 45, revenue: "KSh 180K", rating: 4.9 },
    { name: "Corporate Event Catering", bookings: 32, revenue: "KSh 140K", rating: 4.8 },
    { name: "Sound & DJ Services", bookings: 28, revenue: "KSh 85K", rating: 4.7 },
        ...
        <div className="max-w-7xl mx-auto p-6 lg:p-8 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Welcome back, {user?.name || "Vendor"}! Here's your business performance.
            </p>
          </div>
